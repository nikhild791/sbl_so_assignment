  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-lg mx-auto">
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl p-4 sm:p-6 md:p-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-semibold leading-tight text-gray-900 dark:text-gray-100">
                  {title}
                </h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Tracking progress of background job
                </p>
              </div>
            </div>
          ...
          <div className="mt-4 text-right text-sm text-gray-500 dark:text-gray-400">
            This will update automatically as each step completes.
          </div>
        </div>
      </div>
    </div>
